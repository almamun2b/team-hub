...
Implement **two** of the following. State your choices clearly in the README.
...
Deploy both apps on Railway as separate services inside one Railway project. Provision a PostgreSQL database through Railway's plugin — it injects `DATABASE_URL` automatically. Each service needs its own environment variables set in Railway's variable panel.
...
- [ ] **Live URLs** — Two Railway links — web app and API, with a seeded demo account ready to log in
- [ ] **GitHub repo** — Public, clean commit history using conventional commits
- [ ] **README.md** — Project overview, setup instructions, env variable reference, which 2 advanced features you built, and known limitations
...
Email [hiring@fredocloud.com](mailto:hiring@fredocloud.com) with subject line `[Technical Assessment]`

*Good luck — we're excited to see what you build.*

---

*SRTI Park, Block B, Sharjah, United Arab Emirates | +971 54 778 5061 | info@fredocloud.com | www.fredocloud.com*
